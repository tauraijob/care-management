    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
      ...
      <div class="mb-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <img src="/uploads/companion-care.jpg" alt="Companion Care" class="w-full h-80 object-cover rounded-xl shadow" />
          <div>
            <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-6">
              <Icon name="mdi:account-group" class="text-3xl text-green-600" />
            </div>
            <h2 class="text-3xl font-bold text-gray-900 mb-4">Companion Care Services</h2>
            <p class="text-xl text-gray-600">
              Our Companion Care services provide a warm, reliable presence offering social connection, light housekeeping,
              errands, and support with daily routines. We help maintain independence while providing meaningful companionship.
            </p>
          </div>
        </div>
      </div>
