        ...
        <div class="flex items-center space-x-4">
          ...
          <div ref="notificationsRef" class="relative">
            <button 
              ...
              class="p-2 text-gray-600 hover:text-lucerna-primary transition-colors duration-200 hover:bg-lucerna-background rounded-lg"
            >
          ...
          <div ref="userMenuRef" class="relative">
            ...
            >
              ...
              <div class="hidden md:block text-left">
                <p class="text-sm font-medium">{{ user?.firstName || 'Admin' }} {{ user?.lastName || 'User' }}</p>
...
const unreadNotifications = ref(5) // This would come from your notifications system
